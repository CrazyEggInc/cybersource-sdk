defmodule CyberSourceSDK.CreditCardTest do
      ...
      assert card ==
               {:ok,
                %{
                  ...
                  paySubscriptionCreateReply: %{reasonCode: 100, subscriptionID: 123_456_789},
                  paySubscriptionDeleteReply: nil,
                  paySubscriptionRetrieveReply: nil,
                  paySubscriptionUpdateReply: nil,
                  reasonCode: 100,
                  requestID: 1_234_592_242_856_049_004_012,
                  requestToken:
                    "ABCDEFGSTOog0ehNMRk3sABRRqAPeVGYCo1AHvHjPSAAA5DJpJli6+Bg4kCcmdRBo9CaYjJvYAAAAqgih",
                  voidReply: nil,
                  invalidField: "",
                  missingField: ""
                }}
      ...
      assert card ==
               {:ok,
                %{
                  ...
                  paySubscriptionUpdateReply: nil,
                  reasonCode: 100,
                  requestID: 1_234_592_252_656_050_004_012,
  ...
  test "Can update a card" do
    use_cassette "update card" do
      bill_to =
        CyberSourceSDK.bill_to("Joe", "Bloggs", nil, nil, nil, nil, nil, nil, "joe@bloggs.com")
    ...
    use_cassette "charge card" do
      ...
      assert charge == %{
               ...
               ccCaptureReply: %{
                 amount: 10.1,
                 reasonCode: 100,
                 reconciliationID: "123456552IRLSV5JLP1DC",
                 requestDateTime: "2020-01-28T11:13:24Z"
               },
               ccCreditReply: nil,
               decision: "ACCEPT",
               fault: nil,
               ...
               paySubscriptionUpdateReply: nil,
               reasonCode: 100,
               requestID: 1_234_500_040_956_805_804_009,
               requestToken:
                 "ABCDEFGTOohQLmgdzm/pABQq3cuW7Bs1aspNKZTrNZUygxiQ1GoA98GZgKjUAe+DM9IFfkAOQyaSZYuvgYOIGBOTOohQLmgdzm/pAAAARhq0",
               voidReply: nil,
               invalidField: "",
               missingField: ""
             }
  ...
  test "Can delete a card" do
    use_cassette "delete card" do
      ...
      assert deleted_card == %{
               ...
               originalTransaction: nil,
               paySubscriptionCreateReply: nil,
               paySubscriptionDeleteReply: %{reasonCode: 100, subscriptionID: 234_567_891},
               paySubscriptionRetrieveReply: nil,
               paySubscriptionUpdateReply: nil,
               reasonCode: 100,
               requestID: 1_234_501_006_036_850_704_009,
